...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AL: x0 => x0.rasterStartMilliseconds,
      AM: (x0,x1) => x0.connect(x1),
      AN: (x0,x1) => { x0.multiple = x1 },
      ...
      CJ: x0 => x0.signal,
      CK: (x0,x1) => x0.send(x1),
      CL: x0 => x0.canvasKitMaximumSurfaces,
      CM: (x0,x1,x2) => x0.start(x1,x2),
      CN: (x0,x1) => { x0.type = x1 },
      ...
      DJ: x0 => x0.abort(),
      DK: x0 => x0.send(),
      DL: x0 => x0.nextSibling,
      DM: x0 => x0.getOutputTimestamp(),
      DN: x0 => globalThis.URL.revokeObjectURL(x0),
      E: (exn) => {
      ...
      EK: x0 => x0.abort(),
      EL: (x0,x1) => x0.debug(x1),
      EM: x0 => x0.outputLatency,
      EN: (x0,x1) => { x0.download = x1 },
      F: () => new Error().stack,
      ...
      FK: x0 => x0.readyState,
      FL: x0 => x0.hostElement,
      FM: x0 => x0.baseLatency,
      FN: (x0,x1) => { x0.target = x1 },
      ...
      HK: x0 => x0.loaded,
      HL: (x0,x1) => x0.getModifierState(x1),
      HM: x0 => x0.currentTime,
      HN: x0 => x0.href,
      ...
      IK: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      IL: x0 => x0.metaKey,
      IM: (x0,x1) => { x0.onended = x1 },
      IN: x0 => x0.location,
      ...
      JL: x0 => x0.altKey,
      JM: (x0,x1) => ({latencyHint: x0,sampleRate: x1}),
      JN: x0 => x0.length,
      K: (exn) => {
      ...
      KI: (x0,x1) => { x0.src = x1 },
      KJ: x0 => x0.style,
      KK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      KL: x0 => x0.ctrlKey,
      KM: x0 => new AudioContext(x0),
      KN: x0 => x0.getReader(),
      L: o => o === undefined,
      ...
      PL: x0 => x0.userAgent,
      PM: (x0,x1) => { x0.value = x1 },
      PN: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      RK: x0 => x0.response,
      RL: (x0,x1) => x0.canShare(x1),
      RM: (x0,x1) => { x0.buffer = x1 },
      RN: x0 => x0.loader,
      ...
      SK: x0 => x0.withCredentials,
      SL: (x0,x1) => x0.share(x1),
      SM: x0 => x0.duration,
      SN: () => globalThis._flutter,
      T: x0 => new Promise(x0),
      ...
      VJ: x0 => x0.send(),
      VK: (x0,x1) => { x0.withCredentials = x1 },
      VL: x0 => x0.close(),
      VM: (x0,x1,x2,x3) => x0.createBuffer(x1,x2,x3),
      W: x0 => new Array(x0),
      WB: o => {
      ...
      WL: x0 => x0.load(),
      WM: (x0,x1,x2) => x0.copyToChannel(x1,x2),
      X: o => [o],
      ...
      XJ: x0 => x0.response,
      XK: () => new FileReader(),
      XL: (x0,x1) => x0.removeAttribute(x1),
      XM: (x0,x1) => x0.setSinkId(x1),
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      YC: (x0,x1) => x0.test(x1),
      ...
      ZK: x0 => x0.result,
      ZL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      hK: (x0,x1,x2) => x0.insertBefore(x1,x2),
      ...
      kJ: x0 => x0.length,
      kK: x0 => x0.offsetWidth,
      kL: x0 => x0.currentTime,
      ...
      mK: x0 => x0.disabled,
      mL: x0 => x0.code,
      mM: x0 => globalThis.URL.createObjectURL(x0),
      ...
      oK: (x0,x1) => { x0.max = x1 },
      oL: (x0,x1) => { x0.currentTime = x1 },
      oM: (x0,x1) => new Blob(x0,x1),
      p: b => !!b,
      ...
      qK: (x0,x1) => { x0.scrollLeft = x1 },
      qL: (x0,x1) => { x0.preload = x1 },
      qM: x0 => x0.name,
      r: (x0,x1) => x0.focus(x1),
      ...
      tK: (x0,x1) => x0.transferFromImageBitmap(x1),
      tL: x0 => x0.play(),
      ...
      zK: x0 => x0.rasterEndMilliseconds,
      zL: x0 => x0.createBufferSource(),
      zM: (x0,x1) => { x0.accept = x1 },
