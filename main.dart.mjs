...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CI: x0 => x0.deref(),
      CJ: x0 => x0.signal,
      CK: x0 => x0.clearMeasures,
      CL: x0 => x0.hostElement,
      CM: (x0,x1) => x0.removeChild(x1),
      ...
      FK: () => globalThis.performance,
      FL: x0 => x0.metaKey,
      FM: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      ZM: x0 => globalThis.URL.revokeObjectURL(x0),
      ...
      fJ: (x0,x1) => x0._malloc(x1),
      fK: x0 => x0.id,
      fL: x0 => x0.currentTime,
      fM: x0 => x0.length,
      ...
      hJ: (x0,x1,x2,x3,x4,x5) => x0._et_mseed_decode(x1,x2,x3,x4,x5),
      ...
      jI: x0 => x0.image,
      jJ: (x0,x1) => x0._et_mseed_trace_count(x1),
      jK: x0 => x0.disabled,
      jL: (x0,x1) => { x0.currentTime = x1 },
      jM: x0 => x0.read(),
      k: o => o,
      ...
      lJ: (x0,x1,x2) => x0._et_mseed_trace_source_identifier(x1,x2),
      lK: (x0,x1) => { x0.max = x1 },
      ...
      mJ: (x0,x1,x2) => x0._et_mseed_trace_samples(x1,x2),
      ...
      nJ: (x0,x1,x2) => x0._et_mseed_trace_sample_count(x1,x2),
      ...
      oI: (x0,x1) => x0.get(x1),
      oJ: (x0,x1,x2) => x0._et_mseed_trace_sample_rate(x1,x2),
      ...
      pJ: (x0,x1,x2) => x0._et_mseed_trace_start_time_microseconds(x1,x2),
      ...
      tH: x0 => x0.unlock(),
      tI: x0 => x0.url,
      tJ: () => globalThis.createEarthtunesMSeedModule(),
      tK: (x0,x1) => { x0.width = x1 },
      tL: (x0,x1) => x0.setSinkId(x1),
      u: () => [],
      ...
      wI: x0 => x0.read(),
      wJ: (x0,x1) => x0.parse(x1),
      wK: x0 => x0.rasterEndMilliseconds,
      wL: () => globalThis.document,
      ...
      yI: x0 => x0.done,
      yJ: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
